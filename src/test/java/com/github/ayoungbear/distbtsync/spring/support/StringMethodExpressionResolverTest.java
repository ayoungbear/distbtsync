...
import com.github.ayoungbear.distbtsync.BaseSpringTest;
import com.github.ayoungbear.distbtsync.spring.support.StringMethodExpressionResolverTest.ExpressionTestConfiguration;
import com.github.ayoungbear.distbtsync.spring.support.StringMethodExpressionResolverTest.ExpressionTestConfiguration.ExpressionService;
...
@ContextConfiguration(classes = ExpressionTestConfiguration.class)
public class StringMethodExpressionResolverTest extends BaseSpringTest {
    ...
    public void testResolveMethodExpressionWithBeanFactory() throws Exception {
        ...
        String expr =
                "methodName=#{#methodName} targetClass=#{#targetClass.getSimpleName()} map.size=#{#args[0].size()} "
